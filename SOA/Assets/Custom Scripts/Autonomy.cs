...
namespace autonomy_msg {
  ...
  public static partial class Autonomy {
    ...
    static Autonomy() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          ...
          "EhAKCGFjdG9yX2lkGAMgAigFEg8KB21vZGVfaWQYBCACKAUihwEKDEdwYl9X" + 
          "YXlwb2ludBITCgtiZWxpZWZfdGltZRgBIAIoBBIUCgxyZXF1ZXN0X3RpbWUY" + 
          "AiACKAQSEAoIYWN0b3JfaWQYAyACKAUSDQoFcG9zX3gYBCACKAISDQoFcG9z" + 
          "X3kYBSACKAISDQoFcG9zX3oYBiACKAISDQoFc3BlZWQYByACKAIiLQoIR3Bi" + 
          "X1RpbWUSEwoLYmVsaWVmX3RpbWUYASACKAQSDAoEdGltZRgCIAIoBCJgCgxH" + 
          "cGJfUm9hZENlbGwSEwoLYmVsaWVmX3RpbWUYASACKAQSEQoJaXNSb2FkRW5k" + 
          "GAIgAigIEigKBGNlbGwYAyACKAsyGi5hdXRvbm9teV9tc2cuR3BiX0dyaWRD" + 
          "ZWxsImYKEkdwYl9TaW5nbGVXYXlwb2ludBIJCgF4GAEgAigCEgkKAXkYAiAC" + 
          "KAISCQoBehgDIAIoAhINCgVzcGVlZBgEIAIoAhIPCgdoZWFkaW5nGAUgAigC" + 
          "Eg8KB3Zpc2l0ZWQYBiACKAgihAEKEEdwYl9XYXlwb2ludFBhdGgSEwoLYmVs" + 
          "aWVmX3RpbWUYASACKAQSFAoMcmVxdWVzdF90aW1lGAIgAigEEhAKCGFjdG9y" + 
          "X2lkGAMgAigFEjMKCXdheXBvaW50cxgEIAMoCzIgLmF1dG9ub215X21zZy5H" + 
          "cGJfU2luZ2xlV2F5cG9pbnQieQoUR3BiX0Nhc3VhbHR5RGVsaXZlcnkSEwoL" + 
          "YmVsaWVmX3RpbWUYASACKAQSFAoMcmVxdWVzdF90aW1lGAIgAigEEhAKCGFj" + 
          "dG9yX2lkGAMgAigFEg4KBmdyZWVkeRgEIAIoCBIUCgxtdWx0aXBsaWNpdHkY" + 
          "BSACKAUidQoQR3BiX1N1cHBseVBpY2t1cBITCgtiZWxpZWZfdGltZRgBIAIo" + 
          "BBIUCgxyZXF1ZXN0X3RpbWUYAiACKAQSEAoIYWN0b3JfaWQYAyACKAUSDgoG" + 
          "Z3JlZWR5GAQgAigIEhQKDG11bHRpcGxpY2l0eRgFIAIoBQ==");
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_autonomy_msg_Gpb_Waypoint__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::autonomy_msg.Gpb_Waypoint, global::autonomy_msg.Gpb_Waypoint.Builder>(internal__static_autonomy_msg_Gpb_Waypoint__Descriptor,
                new string[] { "BeliefTime", "RequestTime", "ActorId", "PosX", "PosY", "PosZ", "Speed", });
        ...
        internal__static_autonomy_msg_Gpb_SingleWaypoint__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::autonomy_msg.Gpb_SingleWaypoint, global::autonomy_msg.Gpb_SingleWaypoint.Builder>(internal__static_autonomy_msg_Gpb_SingleWaypoint__Descriptor,
                new string[] { "X", "Y", "Z", "Speed", "Heading", "Visited", });
  ...
  public sealed partial class Gpb_Waypoint : pb::GeneratedMessage<Gpb_Waypoint, Gpb_Waypoint.Builder> {
    ...
    private static readonly string[] _gpbWaypointFieldNames = new string[] { "actor_id", "belief_time", "pos_x", "pos_y", "pos_z", "request_time", "speed" };
    private static readonly uint[] _gpbWaypointFieldTags = new uint[] { 24, 8, 37, 45, 53, 16, 61 };
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      ...
      if (hasSpeed) {
        output.WriteFloat(7, field_names[6], Speed);
      }
      UnknownFields.WriteTo(output);
    }
    ...
    public override int SerializedSize {
      get {
        ...
        if (hasSpeed) {
          size += pb::CodedOutputStream.ComputeFloatSize(7, Speed);
        }
        size += UnknownFields.SerializedSize;
        memoizedSerializedSize = size;
        return size;
  ...
  public sealed partial class Gpb_SingleWaypoint : pb::GeneratedMessage<Gpb_SingleWaypoint, Gpb_SingleWaypoint.Builder> {
    ...
    private static readonly string[] _gpbSingleWaypointFieldNames = new string[] { "heading", "speed", "visited", "x", "y", "z" };
    private static readonly uint[] _gpbSingleWaypointFieldTags = new uint[] { 45, 37, 48, 13, 21, 29 };
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      ...
      if (hasSpeed) {
        output.WriteFloat(4, field_names[1], Speed);
      }
      if (hasHeading) {
        output.WriteFloat(5, field_names[0], Heading);
      }
      if (hasVisited) {
        output.WriteBool(6, field_names[2], Visited);
      }
      UnknownFields.WriteTo(output);
    }
    ...
    public override int SerializedSize {
      get {
        ...
        if (hasHeading) {
          size += pb::CodedOutputStream.ComputeFloatSize(5, Heading);
        }
        if (hasVisited) {
          size += pb::CodedOutputStream.ComputeBoolSize(6, Visited);
        }
        size += UnknownFields.SerializedSize;
        memoizedSerializedSize = size;
        return size;
