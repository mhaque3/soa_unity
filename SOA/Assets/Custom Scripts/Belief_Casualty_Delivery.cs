...
namespace soa
{
    public class Belief_Casualty_Delivery : Belief
    {
        // Members
        ...
        // Constructor
        public Belief_Casualty_Delivery(ulong request_time, int actor_id, bool greedy, int multiplicity)
            : base(actor_id)
        {
        ...
        {
            return BeliefType.CASUALTY_DELIVERY;
        }

        // String representation
        public override string ToString()
        {
            string s = "Belief_Casualty_Delivery {"
